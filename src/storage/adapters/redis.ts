...
const NOT_YET = (method: string) =>
  new FeatureNotImplementedError(`RedisAdapter.${method}() is a scaffold — not implemented yet. See __placeholder.`);

export class RedisAdapter implements MemoryRepository {
  ...
  public async connect(): Promise<void> {
    ...
    // TODO(scaffold): construct a real `new IORedis(...)` client here.
    this.isConnected = true;
    console.log('[RedisAdapter] Connected to Redis (scaffold — no real client yet)');
  }

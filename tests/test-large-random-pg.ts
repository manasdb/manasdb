...
async function runRandomTextTest(): Promise<void> {
    console.log("=====================================================");
    console.log("[INFO] MANASDB LARGE RANDOM TEXT QA TEST (PostgreSQL)");
    console.log("=====================================================");

    const projectName = 'large_random_pg_test_' + Date.now();

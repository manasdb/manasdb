...
async function runFeaturesTest() {
    ...
    try {
        ...
        const absorb1 = await db.absorb(TEST_TEXT_1);
        ...
        const dedup1 = await db.absorb(TEST_TEXT_2);
        const dedup2 = await db.absorb(TEST_TEXT_2);
        ...
        const recall1: any = await db.recall(queryText, { mode: 'qa', limit: 3 } as any);
        ...
        const recall2: any = await db.recall(queryText, { mode: 'qa', limit: 3 } as any);
        assert(

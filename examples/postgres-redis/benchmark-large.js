...
async function runBenchmark() {
    console.log("=====================================================");
    console.log(" MANASDB: POSTGRESQL + REDIS (MULTI-QUERY BENCHMARK)");
    console.log("=====================================================\n");

    const projectName = 'large_bench_' + Date.now();
    ...
    console.log(`[3] Running Real-World Query Workload...\n`);
    ...
    for (let i = 0; i < QUERIES.length; i++) {
        ...
        tableData.push({
            "Query": `Q${i+1}`,
            "Postgres Vector+JOIN (ms)": `${dbLatency}ms`,
